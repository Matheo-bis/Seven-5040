...
public class Jeu2_2Activity extends Jeu {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numeroJeu=2;
        setContentView(R.layout.activity_jeu2_2);
        qcm();
    }
    ...
    public void qcm () {
        ...
        Button qcmbutton1 = findViewById(R.id.button19);
        Button qcmbutton2 = findViewById(R.id.button20);
        Button qcmbutton3 = findViewById(R.id.button21);
        Button qcmbutton4 = findViewById(R.id.button22);
